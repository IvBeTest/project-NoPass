...
describe('9 test valid corporate name 1 character', () => {
    before(() => {
        cy.visit('/');
    });

    it('Checking the Corporate name field, enter a valid value of 1 character.', () => {
        ...
        cy.get('#mat-input-2').type(testData.validTestData.valid_corporate_name_1_character)
                cy.log("Проверка поля'Corporate name', вводим допустимое значение 1 символ.")
